...
public class Config {
    ...
    // Placement rules. All false = "fixed" behavior; set true to restore the original mod's behavior.
    public static boolean PLACE_IN_WATER = false;
    public static boolean PLACE_IN_LAVA = false;
    public static boolean PLACE_ON_PARTIAL = false;
    public static boolean PLACE_REPLACE_NONFULL = false;
    ...
    public static void reload() {
        ...
        prop = config.get("general", "Place Blocks In Water", false);
        prop.setComment("If True, swarm mobs may place/replace water while bridging (original mod behavior). Default False.");
        PLACE_IN_WATER = prop.getBoolean();

        prop = config.get("general", "Place Blocks In Lava", false);
        prop.setComment("If True, swarm mobs may place/replace lava while bridging (original mod behavior). Default False.");
        PLACE_IN_LAVA = prop.getBoolean();

        prop = config.get("general", "Place On Partial Blocks", false);
        prop.setComment("If True, swarm mobs may place blocks on non-solid tops such as slabs, stairs or torches (original mod behavior). Default False.");
        PLACE_ON_PARTIAL = prop.getBoolean();

        prop = config.get("general", "Replace Non-Full Blocks", false);
        prop.setComment("If True, swarm mobs may replace non-replaceable blocks such as torches and slabs while bridging (original mod behavior). Default False.");
        PLACE_REPLACE_NONFULL = prop.getBoolean();
