...
public class SwarmWorldDiggerBase {
    ...
    public boolean bridge(int x, int y, int z) {
        ...
        // FIX: never replace liquids — swarm must not fill or bridge over water/lava.
        // Liquids report isReplaceable()==true, so without this they get paved over
        // whenever there is a solid block beneath them (shallow pools, lava edges).
